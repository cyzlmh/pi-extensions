...
| [`pi-session-trace`](pi-session-trace/) | [![npm](https://img.shields.io/npm/v/pi-session-trace)](https://www.npmjs.com/package/pi-session-trace) | Pure-TUI session trajectory viewer — live TTFT/decode timeline for the current session, replay of any historical session, no server or browser |
