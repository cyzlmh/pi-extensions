...
| [`pi-msb-sandbox`](pi-msb-sandbox/) | [![npm](https://img.shields.io/npm/v/pi-msb-sandbox)](https://www.npmjs.com/package/pi-msb-sandbox) | Run agent bash inside a libkrun microVM (microsandbox) — fail-closed isolation with two-way workspace delta sync |
